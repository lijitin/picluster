...
# Recommended to copy the file to local machine before plotting. !!!DOES NOT WORK ON piserver
# i.e.
scp -r /exports/all_resource_logs [USER]@[LOCALHOST]:~

# then run
python plot_logs.py [path-to-all_resource_logs-dir] [number-of-active-hosts]
# e.g. python plot_logs ~/all_resource_logs 4 # for experiment ran with only 4 pis.
